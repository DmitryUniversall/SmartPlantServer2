...
from src.app.main.components.storage.models.channel_message import StorageChannelMessage, StorageChannelMessageModel
from src.app.main.db import AsyncDatabaseManagerST
from src.core.utils.singleton import ABCSingletonMeta


class StorageChannelMessageResourceST(ObservableResource[StorageChannelMessageModel, int], metaclass=ABCSingletonMeta):
